    ...
    <div class="max-w-7xl mx-auto px-6 py-6 relative z-10">
        ...
        @if($aksi->isEmpty())
            ...
            <div class="bg-white/70 backdrop-blur-xl border border-white/60 rounded-[2.5rem] shadow-2xl p-12 md:p-16 text-center max-w-2xl mx-auto animate-fade-in">
                ...
                @if(request('search'))
                    <a href="{{ route('aksi.index') }}" class="inline-flex items-center gap-2 bg-gradient-to-r from-ocean-600 to-blue-500 hover:from-ocean-700 hover:to-blue-600 text-white font-bold py-3 px-8 rounded-full shadow-lg hover:shadow-ocean-500/30 hover:scale-105 active:scale-95 transition-all duration-300">
