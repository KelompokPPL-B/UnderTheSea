            ...
            <div class="p-6 sm:p-8">
                ...
                <form method="POST" action="{{ route('ikan.update', $ikan->id_ikan) }}" enctype="multipart/form-data" class="space-y-6">
                    ...
                    <div class="flex flex-col sm:flex-row gap-3 sm:gap-4 pt-6 border-t border-gray-200">
                        <button type="submit" class="flex-1 px-6 py-3 bg-blue-600 hover:bg-blue-700 text-white rounded-lg transition font-medium disabled:opacity-50 disabled:cursor-not-allowed">Update Fish</button>
