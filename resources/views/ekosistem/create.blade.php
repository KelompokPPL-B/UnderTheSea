...
<div class="py-12 bg-gradient-to-b from-ocean-50 via-white to-sand min-h-screen relative overflow-hidden">
    ...
    <div class="max-w-4xl mx-auto px-6 relative z-10">
        ...
        <div class="bg-white rounded-3xl shadow-[0_20px_50px_rgba(8,_112,_184,_0.15)] border border-ocean-100 p-8 md:p-12 relative overflow-hidden transition-all duration-300">
            ...
            <!-- Form -->
            <form action="{{ route('ekosistem.store') }}" method="POST" enctype="multipart/form-data" class="space-y-8 relative z-10">
                @csrf
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="group">
                            <label for="gambar" class="block text-sm font-extrabold text-ocean-900 mb-2 ml-1 group-hover:text-ocean-600 transition-colors">
                                Gambar (JPG, PNG - Max 2MB) <span class="text-emerald-500">*</span>
                            </label>
                            <input 
                                type="file" 
                                id="gambar" 
                    ...
                    <div class="space-y-6">
                        ...
                        <div class="group">
                            ...
                            <textarea 
                                ...
                                placeholder="Bagaimana cara melindungi ekosistem ini?">{{ old('cara_menjaga') }}</textarea>
                            @error('cara_menjaga')
                                <p class="text-red-500 text-xs font-semibold mt-2 ml-1">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="group">
                            ...
                            <textarea 
                                ...
                                placeholder="Hal-hal apa saja yang dilarang atau dapat merusak ekosistem ini?">{{ old('larangan') }}</textarea>
                            @error('larangan')
                                <p class="text-red-500 text-xs font-semibold mt-2 ml-1">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="group">
                            ...
                            <textarea 
                                ...
                                placeholder="Apa konsekuensinya jika ekosistem ini rusak?">{{ old('dampak_kerusakan') }}</textarea>
                ...
                <div class="flex flex-col sm:flex-row gap-4 pt-8 border-t border-ocean-100">
                    <a href="{{ route('ekosistem.index') }}" class="sm:w-1/3 bg-ocean-50 hover:bg-ocean-100 text-ocean-800 font-bold py-4 px-6 rounded-2xl text-center transition-all duration-300 transform hover:-translate-y-1 shadow-sm">
                        Batal
                    </a>
